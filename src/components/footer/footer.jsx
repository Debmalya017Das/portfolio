...
function Footer() {
  return (
    <div className="w-full p-6 bg-white/10 backdrop-blur-md backdrop-saturate-150 border-t border-white/20 shadow-lg">
      <div className="container mx-auto px-4 max-w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-white/70">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white/70 hover:text-white transition-colors duration-300">Portfolio</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors duration-300">FAQs</a></li>
